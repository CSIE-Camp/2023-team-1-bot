...
module.exports = {
     ...
     */
    async execute(client, interaction) {const Discord = require('discord.js');
...
function startGame(player) {
  ...
  if (playerCards[0] === playerCards[1]) {
    ...
    const isCorrectGuess = (guess === '大' && thirdCard > playerCards[0]) || (guess === '小' && thirdCard < playerCards[0]);
    if (isCorrectGuess) {
    ...
    } else if (thirdCard === Math.min(...playerCards) || thirdCard === Math.max(...playerCards)) {
